...
public class ConsistentOntology {
	...
	public static final String PROJECT_TEAM = DOC_NAMESPACE+"ProjectTeam";
	public static final String DESIGNER_TEAM =DOC_NAMESPACE+"DesignerTeam";
	public static final String DEVELOPER_TEAM= DOC_NAMESPACE+"DeveloperTeam";
	public static final String TESTER_TEAM =DOC_NAMESPACE+"TesterTeam";
	public static final String INCLUDE_SUBTEAM = DOC_NAMESPACE+ "includeSubTeam";
	public static final String HAS_MEMBER = DOC_NAMESPACE+ "hasMember";
	public static final String HAS_WORKSPACE = DOC_NAMESPACE+ "hasWorkspace";
	public static final String REQUIREMENT_OF_PROJECT_TEAM = DOC_NAMESPACE + "requirementOfProjectTeam";
	public static final String DOC_DESCRIBE_REQUIREMENT = DOC_NAMESPACE+  "docDescribeRequirement";
	public static final String REQUIREMENT_CODE_BY_DEVELOPER = DOC_NAMESPACE+  "requirementCodedByDeveloper";
	...
	public static final String PARAMATER  = SEC_NAMESPACE+"Parameter";
	public static final String JAVAMODIFIER  = SEC_NAMESPACE+"JavaModifier";
	public static final String CODE_CHANGE = DOC_NAMESPACE+"CodeChange";
	...
	public static final String HAS_NAME  = SEC_NAMESPACE + "hasName";
	...
	public static final String TEST_IS_EXECUTE_BY_TESTER = DOC_NAMESPACE + "testIsExecutedByTester";
	...
	public static final String REQUIREMENT_IS_INSTALLED = SEC_NAMESPACE + "requirementIsInstalled";
	...
	public static final String CODE_RELATED_TO_DOC = DOC_NAMESPACE + "codeRelatedToDoc";
	public static final String IS_DISCARDED = DOC_NAMESPACE + "isDiscarded";
}
