...
public class CompositeViewTreeSourceRequirement extends Composite {
	 ...
	 * @param style
	 */
	public CompositeViewTreeSourceRequirement(Composite parent, int style) {
		super(parent, style);
		...
		selectButton.setImage(SWTResourceManager.getImage(CompositeViewTreeSourceRequirement.class, "/ontology/images/run.gif"));
