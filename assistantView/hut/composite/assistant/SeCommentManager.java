...
public class SeCommentManager extends SeCompositeAnnotatorSuper {

  private Tree tree;
  private TreeViewer treeViewer;
  private SeControllerAnnotator seControllerAnnotator;
  ...
  public void setController() {
    seControllerAnnotator = new SeControllerAnnotator();
    seControllerAnnotator.setCommentContent(seCommentContent);
    seControllerAnnotator.setCommentManager(this);

    this.setController(seControllerAnnotator);
    seCommentContent.setController(seControllerAnnotator);
  }
