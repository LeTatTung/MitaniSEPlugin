...
public class CommentManager extends CompositeAnnotatorSuper {
	...
	public void setController() {
		...
		controllerAnnotator.setCommentContent(commentContent);
		controllerAnnotator.setCommentManager(this);

		this.setController(controllerAnnotator);
		commentContent.setController(controllerAnnotator);
	}
